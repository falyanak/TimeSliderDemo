...
function scope(target, options, originalOptions) {
  ...
  function generateSpread(pips2) {
    ...
    group.forEach(function(current, index2) {
      ...
      for (i = low; i <= high; i = safeIncrement(i, step)) {
        ...
        steps2 = pctDifference / (pips2.density || 1);
        realSteps = Math.round(steps2);
  ...
  function eventKeydown(event, handleNumber) {
    ...
    if (isUp || isDown) {
      ...
      var steps2 = getNextStepsForHandle(handleNumber);
      var step = steps2[direction];
      if (step === null) {
        return false;
      }
      if (step === false) {
  ...
  function checkHandlePosition(reference, handleNumber, to2, lookBackward, lookForward, getValue, smoothSteps) {
    var distance;
    ...
    to2 = limit(to2);
    if (to2 === reference[handleNumber] && !getValue) {
      return false;
    }
    return to2;
  }
  ...
  function moveHandles(upward, proposal, locations, handleNumbers, connect) {
    ...
    if (handleNumbers.length > 1) {
      handleNumbers.forEach(function(handleNumber, o) {
        var to2 = checkHandlePosition(proposals, handleNumber, proposals[handleNumber] + proposal, b[o], f[o], false, smoothSteps);
        if (to2 === false) {
          proposal = 0;
        } else {
...
var PipsMode, PipsType, Spectrum, defaultFormatter, cssClasses, INTERNAL_EVENT_NS, nouislider_default;
var init_nouislider = __esm({
  "node_modules/nouislider/dist/nouislider.mjs"() {
    "use strict";
    (function(PipsMode2) {
...
var init_helpers_dataset = __esm({
  "node_modules/chart.js/dist/chunks/helpers.dataset.js"() {
    ...
    toPercentage2 = (value, dimension) => typeof value === "string" && value.endsWith("%") ? parseFloat(value) / 100 : +value / dimension;
  ...
  "node_modules/chart.js/dist/chart.js"() {
    ...
    DoughnutController = class extends DatasetController {
      ...
      update(mode) {
        ...
        const cutout = Math.min(toPercentage2(this.options.cutout, maxSize), 1);
